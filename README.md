...
mars a mc CompactTextAtZero dump .text HexText asm/add_test.text.hex asm/add_test.asm
mars a mc CompactTextAtZero dump .data HexText asm/add_test.data.hex asm/add_test.asm
iverilog -Wall -o cpu_add.vvp cpu.t.v
vvp cpu_add.vvp
./cpu_add.vvp +mem_text_fn=asm/add_test.text.hex +dump_fn=dump.vcd
